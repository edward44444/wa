    ...
    $.wa.widget('draggable', {
        ...
        _create: function () {
            ...
            handle.css({ 'cursor': 'move' }).bind('mousedown.' + me.name, function (e) {
                ...
                elementPosition = { left: parseFloat(me.element.css('left')) || 0, top: parseFloat(me.element.css('top')) || 0 };
            ...
            if ($.wa.support.touch && handle.touchpunch) {
                handle.touchpunch();
            }
        },
        ...
        destroy: function () {
            if ($.wa.support.touch && this.handle.touchpunch) {
                this.handle.touchpunch('destroy');
            }
