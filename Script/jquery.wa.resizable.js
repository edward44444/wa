...
(function ($, undefined) {
    $.wa.widget('resizable', $.wa.mouse, {
        ...
        _mouseCapture: function (event) {
            ...
            if (pageX >= offset.left + controlArea && pageX <= offset.left + elementOuterWidth - controlArea && pageY >= offset.top && pageY <= offset.top + controlArea) {
                this.orient = 'n';
                this.element.css('cursor', 'n-resize');
                return true;
            }
            if (pageX >= offset.left + controlArea && pageX <= offset.left + elementOuterWidth - controlArea && pageY >= offset.top + elementOuterHeight - controlArea && pageY <= offset.top + elementOuterHeight) {
                this.orient = 's';
                this.element.css('cursor', 's-resize');
                return true;
            }
            if (pageX >= offset.left && pageX <= offset.left + controlArea && pageY >= offset.top + controlArea && pageY <= offset.top + elementOuterHeight - controlArea) {
                this.orient = 'w';
                this.element.css('cursor', 'w-resize');
                return true;
            }
            if (pageX >= offset.left + elementOuterWidth - controlArea && pageX <= offset.left + elementOuterWidth && pageY >= offset.top + controlArea && pageY <= offset.top + elementOuterHeight - controlArea) {
                this.orient = 'e';
                this.element.css('cursor', 'e-resize');
                return true;
            }
            if (pageX > offset.left + elementOuterWidth - controlArea && pageX <= offset.left + elementOuterWidth && pageY >= offset.top && pageY < offset.top + controlArea) {
                this.orient = 'ne';
                this.element.css('cursor', 'ne-resize');
                return true;
            }
            if (pageX >= offset.left && pageX < offset.left + controlArea && pageY >= offset.top && pageY < offset.top + controlArea) {
                this.orient = 'nw';
                this.element.css('cursor', 'nw-resize');
                return true;
            }
            if (pageX > offset.left + elementOuterWidth - controlArea && pageX <= offset.left + elementOuterWidth && pageY > offset.top + elementOuterHeight - controlArea && pageY <= offset.top + elementOuterHeight) {
                this.orient = 'se';
                this.element.css('cursor', 'se-resize');
                return true;
            }
            if (pageX >= offset.left && pageX < offset.left + controlArea && pageY > offset.top + elementOuterHeight - controlArea && pageY <= offset.top + elementOuterHeight) {
                this.orient = 'sw';
        ...
        _mouseStop: function (event) {
            ...
            if (options.helper) {
                ...
                me.element.width(me.helper.width() - me.borderLeftWidth - me.borderRightWidth + me.helperBorderWidth * 2);
                me.element.height(me.helper.height() - me.borderTopWidth - me.borderBottomWidth + me.helperBorderWidth * 2);
